...
public class Java8PredicateChainUnitTest {
    ...
    public void whenFilterListWithCollectionOfPredicatesUsingAnd_thenSuccess() {
        ...
        /**
         * T reduce(T identity, BinaryOperator<T> accumulator); 第一个 非null的对象
         *
         * Optional<T> reduce(BinaryOperator<T> accumulator); 返回optional对象
         */
        Predicate<String> reduce = allPredicates.stream()
